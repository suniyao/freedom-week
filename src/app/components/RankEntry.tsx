...
export default function RankEntry({ userId }: Props) {
  ...
  return (
    <div className="flex justify-center py-2">
      <div className="flex w-full max-w-md items-center gap-4 rounded-xl bg-amber-100 px-4 py-3 shadow-sm transition hover:shadow-md">
